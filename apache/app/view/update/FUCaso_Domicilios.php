...
<html lang="es">
  ...
  <body>
    ...
    <form action="../../model/update/UCaso_Domicilios.php">
        <label>compuesta</label>
        <input type="text" name="compuesta" id="compuesta" required>
        <label>CURP</label>
        ...
        <input type="number" name="IdDomicilio" id="IdDomicilio" required maxlength="11">
        <label></label>
        <input type="submit">
    </form>
    </main>
